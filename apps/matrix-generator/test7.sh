...
sleep 3
curl "http://172.17.13.119:80/conf?namespace=silver&tenants=2&completiontime=110&previoustenants=2&previousconf=0_1_0_2" | jq '.'
sleep 3
curl "http://172.17.13.119:80/conf?namespace=silver&tenants=2&completiontime=100&previoustenants=2&previousconf=0_2_0_0" | jq '.'
sleep 3
