...
#sleep 1
#echo 'curl "http://172.17.13.119:80/conf?namespace=silver&tenants=7&completiontime=140&previoustenants=6&previousconf=0_2_0_1" | jq '.''
#curl "http://172.17.13.119:80/conf?namespace=silver&tenants=7&completiontime=140&previoustenants=6&previousconf=0_2_0_1" | jq '.'
#sleep 1
...
#sleep 1
#echo 'curl "http://172.17.13.119:80/conf?namespace=silver&tenants=9&completiontime=210&previoustenants=8&previousconf=0_2_1_0" | jq '.''
#curl "http://172.17.13.119:80/conf?namespace=silver&tenants=9&completiontime=210&previoustenants=8&previousconf=0_2_1_0" | jq '.'
#sleep 1
