...
def create_app():
    ...
    #scaling function parameters for g7:
    #scalingFunction=ScalingFunction(24.44144249,0.01405306,0, {"cpu": 2, "memory": 2}, alphabet['elements'],alphabet['costs'], initial_config["dominant_resources"],NODES, initial_config)
